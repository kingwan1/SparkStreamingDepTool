/**
 * Copyright (C) 2019 wzs All Rights Reserved.
 */
 ...
 * @date 2019-01-10
 */
public abstract class SumOutPutTablePartitionedCalcNode<T> extends MapPartitionsCalcNode<T, T> {
     ...
     */
    public SumOutPutTablePartitionedCalcNode(CalcNodeParams calcNodeParams) {
